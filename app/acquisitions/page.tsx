          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1.1] text-white">
                Accelerate <br/>
                <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-300 via-blue-500 to-purple-500 animate-gradient-x">
                  Growth.
                </span>
              </h1>
              ...
              <div className="flex gap-4">
                 <button className="px-8 py-4 bg-white text-black font-bold rounded-full hover:scale-105 transition-all flex items-center gap-2">
            ...
            >
              ...
              <div className="relative z-10 bg-[#0B0F1A]/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl overflow-hidden">
                 ...
                 <div className="flex items-end gap-4 h-32 mb-8 px-2">
                    ...
                    {/* Fixed h-[100%] to h-full and fixed gradient class */}
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-12">
            {services.map((service, i) => (
              ...
              >
                {/* Fixed flex-shrink-0 to shrink-0 */}
